...
export const metadata: Metadata = {
  title: 'Nasir Mohammed Bala | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Nasir Mohammed Bala! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
